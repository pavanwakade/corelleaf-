    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/3 left-2/3">
          <div
            className="w-20 h-20 border border-purple-200/40 rounded-2xl animate-spin"
            style={{ animationDuration: "15s" }}
          />
        </div>
        <div className="absolute transform -translate-x-1/2 -translate-y-1/2 top-2/3 left-1/4">
          <div
            className="w-12 h-12 border rounded-full border-blue-200/40 animate-bounce"
      ...
      <div className="container relative px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div
          className={`mb-12 sm:mb-16 lg:mb-20 text-center transform transition-all duration-1000 ${
        ...
        {/* Features Section */}
        <div
          className={`grid gap-4 sm:gap-6 sm:grid-cols-3 mb-12 sm:mb-16 transform transition-all duration-1000 delay-200 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}
        >
          ...
          >
            <div>
              ...
              <p className="text-base leading-relaxed text-gray-600 sm:text-lg">
                Whether you're starting from scratch or refining a big idea,
                we're excited to help. Let’s connect and turn your thoughts into
            ...
            <div className="space-y-4 sm:space-y-6">
              {contactInfo.map((info, index) => (
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${info.color} opacity-0 group-hover:opacity-10 rounded-2xl transition-all duration-500 transform group-hover:scale-105`}
                  />

                  {/* Main card */}
                  <div
                    className={`relative flex items-start gap-4 p-4 sm:p-5 bg-white/80 backdrop-blur-sm border-2 ${info.borderColor} shadow-lg rounded-2xl group-hover:shadow-2xl transition-all duration-500 group-hover:bg-white/90 group-hover:-translate-y-1`}
                  >
                    {/* Icon container */}
                    <div
                      className={`flex-shrink-0 p-3 ${info.bgColor} rounded-2xl group-hover:scale-110 transition-transform duration-300 relative overflow-hidden`}
                    >
                      <div
                        className={`absolute inset-0 bg-gradient-to-br ${info.color} opacity-20 group-hover:opacity-40 transition-opacity duration-300`}
                      />
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-2 mb-1 sm:mb-2">
                        ...
                        <div
                          className={`flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full bg-gradient-to-r ${info.color} text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                        >
                          {info.accentIcon}
                          {info.response}
                        </div>
                    ...
                    <div className="absolute transition-all duration-300 opacity-0 top-3 right-3 sm:top-4 sm:right-4 group-hover:opacity-100 group-hover:scale-110">
                      <div
                        className={`p-1.5 sm:p-2 rounded-full bg-gradient-to-br ${info.color} text-white shadow-lg`}
                      >
                        <Send size={16} />
                      </div>
                    </div>
              ...
              <div className="relative z-10">
                {isSubmitted ? (
                  <div className="py-12 text-center sm:py-16">
                    ...
                    <h3 className="mb-3 text-2xl font-black text-gray-900 sm:mb-4 sm:text-3xl">
                      Thank You!
                    </h3>
                  ...
                  <>
                    ...
                    >
                        ...
                        <div className="relative">
                          ...
                          <div className="relative">
                            <input
                              ...
                              className={`w-full px-4 py-3 text-base border-2 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 bg-white/80 backdrop-blur-sm ${
                                errors.name
                      ...
                      <div className="relative">
                        ...
                        <div className="relative">
                          <textarea
                            ...
                            onBlur={() => setFocusedField(null)}
                            className={`w-full px-4 py-3 text-base border-2 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 resize-none bg-white/80 backdrop-blur-sm ${
                              errors.message
                                ? "border-red-500"
                      ...
                      >
                        ...
                        <Send
                          className={`ml-2 sm:ml-3 transition-all duration-300 group-hover:translate-x-1 group-hover:scale-110 ${
                            isSubmitting ? "opacity-0" : "opacity-100"
                          }`}
                          size={20}
                        />

...
//     longDescription: 'Netguru collaborated with UBS to redesign their mobile banking app, emphasizing user-centric design with a unified payment flow and consistent features. The project improved app store ratings and accelerated login processes, involving a team extension model for native design implementation.',
//     image: 'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
//     tags: ['Mobile Development', 'UX/UI Design', 'Banking'],
//     liveUrl: '#',
//   },
//   {
//     title: 'Video Platform Design System',
//     description: 'A blockchain-based video platform with a customizable design system for creators.',
//     longDescription: 'Joystream partnered with Netguru to develop the Atlas design system, featuring over 190 global components and 175 design tokens for consistency. It enables creators to publish and manage content via blockchain transactions, enhancing user experience and operational efficiency.',
//     image: 'https://images.pexels.com/photos/3861958/pexels-photo-3861958.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
...
//     longDescription: 'Netguru worked with Otodom to enhance Poland’s premier real estate marketplace through user research and A/B testing. The project resulted in a 21% increase in conversion rates and a customizable email notification system, boosting traffic and retention.',
//     image: 'https://images.pexels.com/photos/3862132/pexels-photo-3862132.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
...
//     longDescription: 'This system uses Python to create an AI mental health therapist chatbot that provides consultations and support. It integrates natural language processing for accurate responses and has been implemented in various healthcare apps to improve accessibility and user satisfaction.',
//     image: 'https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
...
//     longDescription: 'Built using machine learning, this tool monitors and removes fake product reviews on e-commerce sites, ensuring trust and authenticity. It has been applied in platforms like Shopify integrations, leading to improved customer confidence and higher sales conversions.',
//     image: 'https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
//     tags: ['Machine Learning', 'E-Commerce', 'Python'],
//     liveUrl: '#',
//   },
//   {
//     title: 'Blockchain Shipment Management',
//     description: 'A tracking system for secure and transparent supply chain management.',
//     longDescription: 'This blockchain-based system tracks shipments with evidence protection, using smart contracts for transparency. It has been used in logistics to reduce fraud and improve efficiency, processing high volumes of transactions securely.',
//     image: 'https://images.pexels.com/photos/230544/pexels-photo-230544.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
...
//                   <h6 className="mb-2 text-xs font-bold text-white sm:text-2xl md:text-3xl">
//                     {project.title}
//                   </h6>
...
//                   >
//                     See More <ArrowRight className="ml-1.5" size={10} />
//                   </button>
//                 </div>
//               </div>
  ...
  return (
    <section id="portfolio" className="min-h-screen py-10 sm:py-16 md:py-20 bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            >
              <div className="relative overflow-hidden">
                <img
                  src={project.image}
                  // alt={project.title}
                  className="object-cover w-full h-64 transition-transform duration-700 sm:h-72 md:h-80 md:group-hover:scale-110"  // Increased height for taller cards, with responsive scaling
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
              </div>
              ...
              <div className="absolute inset-0 flex flex-col justify-between p-4 transition-opacity duration-500 sm:p-5 md:p-6 bg-black/50 md:bg-black/70 md:opacity-0 group-hover:opacity-100">
                <div className="text-center">
                  <h6 className="mb-2 text-xl font-bold text-white sm:text-2xl md:text-3xl">  
                    {project.title}
                  </h6>
                  <p className="mb-3 text-sm leading-relaxed text-gray-200 sm:text-base">{project.description}</p>
                  <div className="flex flex-wrap justify-center gap-2">
      ...
      {selectedProject && (
        ...
        >
          <div
            className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto sm:max-w-4xl"  // Increased max-width for better responsiveness on larger screens
            onClick={(e) => e.stopPropagation()}
            style={{ animation: 'slideUp 0.4s ease-out' }}
          >
            <button
            ...
            <div className="relative">
              <img
                src={selectedProject.image}
                alt={selectedProject.title}
                className="object-cover w-full h-56 sm:h-64 md:h-72"  // Responsive image height in modal
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
              <div className="absolute bottom-4 left-4 md:bottom-6 md:left-6">
                <h2 className="text-2xl font-bold text-white sm:text-3xl md:text-4xl">
      ...
      <style jsx>{`
        ...
        @media (max-width: 640px) {
          .grid {
            gap: 3rem;  /* Increased gap for better spacing on mobile */
          }
          [style*="animation"] {
            animation-duration: 1s !important;  /* Slower animations for mobile performance */
          }
          .group:hover {
            scale: 1.02 !important;  /* Subtle scale on hover for touch devices */
          }
        }
      `}</style>
    </section>
